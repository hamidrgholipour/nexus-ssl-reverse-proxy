...
mkdir -p /etc/docker/cert.d/nexus-repo.$HOSTNAME:8443/
...
${PWD}/jdk*/bin/keytool -importkeystore -srckeystore ${PWD}/certs/cert-chain.pkcs12  -destkeystore ${PWD}/certs/keystore.jks -deststoretype pkcs12
}
